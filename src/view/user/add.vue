...
<script>
import { checkUsername, checkNickname } from '@/api/admin'
...
const nicknamePassCheck = (rule, value, callback) => {
    ...
    return {
      ...
      ruleValidate: {
        name: [
          ...
          { validator: nicknamePassCheck, trigger: 'blur' }
        ],
        username: [
          { required: true, message: '请输入用户昵称', trigger: 'blur' },
